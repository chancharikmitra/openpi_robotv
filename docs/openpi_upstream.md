<!--
This is the upstream openpi README, preserved here for reference (installation,
model checkpoints, inference, PyTorch support, troubleshooting).

For THIS fork's method — "Mechanistic Finetuning of Vision-Language-Action Models
via Few-Shot Demonstrations" (ECCV 2026) — see the top-level README: ../README.md
-->

# openpi (upstream framework)
