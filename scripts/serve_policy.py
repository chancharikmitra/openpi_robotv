...
DEFAULT_CHECKPOINT: dict[EnvMode, Checkpoint] = {
   ...
   EnvMode.LoRA_Joint: Checkpoint(
         config = "pi05_All_heads_LoRA",
         dir = "/darrell_robotics/raj_home/rtv/openpi_robotv/checkpoints/pi05_ckpts/table2/LoRA_Multitask_Joint/pi05_All_heads_LoRA/pi05_All_heads_LoRA_place_marker_in_mug_20_new_place_green_cube_in_red_bowl_20_new_merged/2999",
    ),
