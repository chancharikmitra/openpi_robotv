...
#SBATCH --output=/scr2/yusenluo/openpi_robotv/src/openpi/slurm_output/finetune/head_lora_tune_KNN_cosine_K=30_without_img.txt
...
#XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 python scripts/train.py pi0_fast_droid_h5_finetune --exp-name=all_heads_lora_tune_without_img_on_robot_debug --overwrite
