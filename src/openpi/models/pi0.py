    ...
    def sample_actions(
        ...
        *,
        ...
        if return_attention_heads or return_attention_probs or return_action_expert_activations:
            ...
            # Handle action expert activations from prefill if present
            if return_action_expert_activations:
                action_expert_heads = out.get("action_expert_heads")
                if action_expert_heads is not None:
                    attention_outputs["action_expert_prefill_activations"] = action_expert_heads[None, ...]
        else:
        ...
        if return_attention_heads or return_attention_probs or return_action_expert_activations or return_state_heads or return_state_and_first_action_heads:
