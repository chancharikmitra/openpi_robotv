...
#python scripts/compute_norm_stats.py --config-name=pi0_fast_droid_h5_full_finetune
...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 python scripts/train.py pi0_fast_droid_h5_head_tune_debug --exp-name=head_tune_verification --overwrite
