...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_droid_h5_finetune_sanity_check_pick_green_cube",
        model=pi0.Pi0Config(
            action_dim=8,
            action_horizon=16,
            max_token_len=180,
        ...
        data=H5DroidDataConfig(
            ...
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            h5_path="/home/yusenluo/openpi_robotv/pick_green_cube_20.h5",
    ...
    TrainConfig(
        name="pi0_fast_droid_h5_finetune_sanity_check_pick_green_cube_FFT",
        model=pi0_fast.Pi0FASTConfig(
            action_dim=8,
            action_horizon=16,
            max_token_len=180,
    ...
    TrainConfig(
        ...
        data=H5DroidDataConfig(
            repo_id="on_robot_pick_up_green_cube_joint_velocity_sanity_check_KNN_cosine_K=20_20",
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            h5_path="/home/yusenluo/openpi_robotv/pick_green_cube_20.h5",
            action_space=droid_h5_dataset.DroidActionSpace.JOINT_VELOCITY,
            fixed_instruction="pick up green cube",  # fixed instruction
    ...
    TrainConfig(
        name="pi0_fast_droid_h5_head_lora_tune_on_robot",
        model=pi0_fast.Pi0FASTConfig(
            action_dim=8,
            action_horizon=16,
            max_token_len=180,
